		...
		<Flex justifyContent="center" gap={0} px={{ base: 2, md: 8 }}>
			<VStack alignItems="center" gap={16} textAlign="center">
				...
				<Text w={{ base: "100%", md: "60%" }}>
					Somos a CRIS ROCHA MÁQUINAS LTDA. Um a Empresa inserida a mais de 20 anos
					no mercado de Máquinas de Costura Industrias convencionais e eletrônicas.
					Tendo como parceiros, fornecedores das marcas mais consolidadas no mercado
					de máquinas de costura do pais. Atuamos no mercado também dando assistência
					técnica, com uma equipe de colaboradores especializados que atendem tanto
					no pós venda quanto na assistência técnica.
				</Text>
